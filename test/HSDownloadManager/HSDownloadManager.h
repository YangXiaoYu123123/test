 ...
 */
- (void)download:(NSString *)url name:(NSString *)name progress:(void(^)(NSInteger receivedSize, NSInteger expectedSize, CGFloat progress))progressBlock state:(void(^)(DownloadState state))stateBlock;
