...
-(NSMutableAttributedString *)changString:(NSString *)sting Color:(UIColor *)color {
    NSMutableAttributedString * complteAttriString = [[NSMutableAttributedString alloc]initWithString:self];
    NSRange stringRange = [self rangeOfString:sting];
    [complteAttriString addAttribute:NSForegroundColorAttributeName value:color range:stringRange];//更改颜色
    return complteAttriString;
}
-(NSMutableAttributedString *)changString:(NSString *)sting Font:(UIFont* )font{
    NSMutableAttributedString * complteAttriString = [[NSMutableAttributedString alloc]initWithString:self];
    NSRange stringRange = [self rangeOfString:sting];
    [complteAttriString addAttribute:NSFontAttributeName value:font range:stringRange];//更改字体
    return complteAttriString;
}
